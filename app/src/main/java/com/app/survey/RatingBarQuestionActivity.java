...
public class RatingBarQuestionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rating_bar_question);
    ...
    public void save(View v)
    {
        ...
        {
            Toast.makeText(RatingBarQuestionActivity.this , "please enter question" , Toast.LENGTH_SHORT).show();
