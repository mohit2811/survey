...
public class SlidingQuestionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sliding_question);
    ...
    public void save(View view) {
        ...
        {
            Toast.makeText(SlidingQuestionActivity.this , "please enter question" , Toast.LENGTH_SHORT).show();
