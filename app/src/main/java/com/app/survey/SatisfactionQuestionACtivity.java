...
public class SatisfactionQuestionACtivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_satisfaction_question_activity);
    ...
    public void save(View view) {
        ...
        {
            Toast.makeText(SatisfactionQuestionACtivity.this , "please enter question" , Toast.LENGTH_SHORT).show();
