...
public class NumberInputQuestion extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_number_input_question);
        ...
        pd = new ProgressDialog(NumberInputQuestion.this);
        pd.setTitle("Loading");
    ...
    public void preview(View view) {
        ...
        if(validate_input())
        {
            Intent i = new Intent(NumberInputQuestion.this, TextInputAnswer.class);
    ...
    private Boolean validate_input()
    {
        ...
        {
            Toast.makeText(NumberInputQuestion.this , "enter some question" , Toast.LENGTH_SHORT).show();
